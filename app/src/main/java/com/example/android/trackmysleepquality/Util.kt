...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMill != it.startTimeMilli) {
                ...
                // Hours
                append("\t ${it.endTimeMill.minus(it.startTimeMilli) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTimeMill.minus(it.startTimeMilli) / 1000 / 60}:")
                // Seconds
                append("${it.endTimeMill.minus(it.startTimeMilli) / 1000}<br><br>")
            }
        }
    }
